...
CREATE TABLE IF NOT EXISTS commandes (
  ...
  delivery_tracking VARCHAR(120) NULL,
  delivery_sync_status ENUM('PENDING','SYNCED','ERROR') NOT NULL DEFAULT 'PENDING',
  delivery_sync_error TEXT NULL,
  delivery_synced_at DATETIME NULL,
  delivery_wilaya_id VARCHAR(30) NULL,
  delivery_commune_id VARCHAR(30) NULL,
  delivery_mode VARCHAR(30) NULL,
  delivery_stop_desk VARCHAR(30) NULL,
  delivery_agency_id VARCHAR(80) NULL,
  delivery_agency_name VARCHAR(255) NULL,
  ...
  INDEX idx_commandes_delivery_tracking (delivery_tracking),
  INDEX idx_commandes_delivery_sync (delivery_sync_status)
) ENGINE=InnoDB;
