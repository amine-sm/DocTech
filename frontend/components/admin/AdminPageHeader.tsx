...
export default function AdminPageHeader({
  ...
  const finalIcon = action?.icon ?? <Plus size={15} strokeWidth={2.5} />;

  const actionClass =
    "group inline-flex h-11 shrink-0 items-center justify-center gap-2 " +
    "rounded-2xl bg-[#1B4F59] px-5 text-xs font-black text-white " +
    "shadow-lg shadow-[#1B4F59]/20 transition-all duration-200 " +
    "hover:-translate-y-0.5 hover:bg-[#143D45] hover:shadow-xl " +
  ...
  return (
    <section className="relative mb-6 overflow-hidden rounded-[28px] border border-slate-200/80 bg-white shadow-[0_8px_30px_rgba(15,23,42,0.045)]">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -right-20 -top-28 h-64 w-64 rounded-full bg-[#1B4F59]/[0.055] blur-3xl" />

        <div className="absolute -bottom-28 left-[38%] h-56 w-56 rounded-full bg-[#FE5737]/[0.045] blur-3xl" />

        <div className="absolute right-[25%] top-1/2 h-24 w-24 -translate-y-1/2 rounded-full bg-[#1B4F59]/[0.035] blur-2xl" />
      </div>
      ...
      <div className="relative px-5 py-6 sm:px-7 sm:py-7 lg:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-[0.18em] text-[#1B4F59]">
                    {eyebrow}
                  </span>
        ...
        <div className="mt-5 flex items-center gap-1.5">
          ...
          <span className="h-[3px] w-8 rounded-full bg-[#1B4F59]" />
