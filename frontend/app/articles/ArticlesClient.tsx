...
export default function ArticlesClient() {
  ...
  const title =
    ...
    text("Tous les articles", "كل المنتجات");
    ...
    <div className="min-h-screen bg-white pb-[76px] text-slate-950 md:pb-0">
      ...
      <main className="bg-white">
        ...
        {/* =========================
            CONTENT
        ========================= */}
        <section className="mx-auto max-w-[1450px] bg-white px-4 py-7 sm:px-6 lg:px-8 lg:py-10">
              ...
              <div className="flex gap-2 overflow-x-auto pb-1">
                {brands.map((item) => (
                  <Link
                    ...
                    className={`flex shrink-0 items-center gap-2 rounded-2xl border px-3 py-2 text-[10px] font-black ${
                      brand === item.slug
          ...
          <div className="mb-6 grid gap-3 lg:grid-cols-[1fr_auto]">
            ...
            <div className="relative">
              <Search
                className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 rtl:left-auto rtl:right-4"
                size={18}
              />
              ...
              <input
                ...
                className="h-13 w-full rounded-2xl border border-slate-200 bg-white ps-12 pe-4 text-sm font-semibold text-slate-900 outline-none placeholder:text-slate-400 focus:border-blue-300"
              />
            </div>
            ...
            <div className="flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-3">
              ...
              <select
                ...
                className="h-12 bg-transparent text-xs font-black text-slate-900 outline-none"
              >
...
function CategoryPill({
  ...
  return (
    <Link
      href={href}
      className={`flex shrink-0 items-center gap-2 rounded-2xl border px-3 py-2 text-[10px] font-black transition ${
        active
          ? "border-blue-200 bg-blue-50 text-blue-700"
