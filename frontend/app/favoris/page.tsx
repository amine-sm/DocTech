    ...
    <div className="min-h-screen bg-[#f7f9fd] pb-[76px] text-slate-950 md:pb-0">
      ...
      <main>
        <ShopHero
          ...
          description={text(
            "Les produits ajoutés avec le cœur restent disponibles pendant votre session de navigation.",
            "المنتجات التي تضيفها بالقلب تبقى محفوظة طوال جلسة التصفح الحالية."
          )}
          icon={<Heart size={13} />}
        />
