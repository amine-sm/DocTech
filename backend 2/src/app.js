...
// En développement local, accepter les deux variantes classiques
// localhost / 127.0.0.1 afin d'éviter les problèmes de cookie/CORS
// lorsque le frontend et l'API n'utilisent pas exactement le même hostname.
